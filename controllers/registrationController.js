...
exports.registration = function (req,res){
    ...
    checkTypeOfSchema(reqBody, req, res);
            ...
            const checkTypeOfSchema = function(reqBody,req,res){
                    ...
                    switch(roleType) {
                        case "student":
                            return validStudentSchemas(reqBody, req, res);
                
                        case "instructor":
                            return  validInstructorSchemas(reqBody, req, res);

                        case "school":
                            return  validSchoolSchemas(reqBody, req, res);
            
                        default:
                            res.status(500).json({ error: 'roleType not found' });
                            break;
                    }
                }
            ...
            const validSchoolSchemas = function (reqBody, req, res){
                const {email,
                       password,
                       phone_number,
                       adress,
            ...
            const validInstructorSchemas = function(reqBody, req,  res){
                const {email,
                       password,
                       phone_number,
                       first_name,
